...
const ShopAccount: FC = (): JSX.Element => {
  return (
    <div className="col-span-8 sm:col-span-3 xl:col-span-1 rounded-lg bg-gray-dark h-[100%] p-[15px] flex flex-col justify-between">
      <img
        src={shop}
        alt=""
        className="w-[100%] h-[85px] rounded-lg hidden sm:inline-block object-cover"
      />
      <div className="hidden sm:block">
        <div className="h-[25px] bg-gray-dark flex gap-2 items-center mt-[5px] ">
          ...
          <div className="ms-auto hidden md:flex gap-2 items-center">
      ...
      <div className="grid grid-cols-2 gap-3 h-[100%] sm:hidden">
        <img
          src={shop}
          alt=""
          className="w-[100%] h-[100%] rounded-lg inline-block object-cover"
        />
