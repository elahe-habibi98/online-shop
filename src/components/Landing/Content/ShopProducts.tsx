...
import item2 from "../../../assets/images/clothing/item2.jpg";
import item3 from "../../../assets/images/clothing/item3.jpg";
import item4 from "../../../assets/images/clothing/item4.jpg";
import item5 from "../../../assets/images/clothing/item5.jpg";
import item6 from "../../../assets/images/clothing/item6.jpg";
import item7 from "../../../assets/images/clothing/item7.jpg";
import item8 from "../../../assets/images/clothing/item8.jpg";
import item9 from "../../../assets/images/clothing/item9.jpg";

const ShopProducts: FC = (): JSX.Element => {
  const items = [item1, item2, item3, item4, item5, item6, item7, item8, item9];
  return (
    <div className="mt-[30px] pe-[10px] border border-black grid grid-cols-4 gap-4 overflow-y-auto h-[300px]">
      {items.map((m: any, index: number) => (
        ...
        >
          ...
          <img src={m} className="w-[100%] h-[60%] " />
