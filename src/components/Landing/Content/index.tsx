...
const Content: FC = (): JSX.Element => {
  return (
    <div className=" col-span-12 lg:col-span-10">
      <div className=" h-[30px] mb-[10px] text-gray-light flex gap-2">
        <span>Home</span>
        <span>{">"}</span>
        <span>Shop</span>
        <span>{">"}</span>
      ...
      <div className="h-[190px] mb-[5px] grid grid-cols-8 xl:grid-cols-4 gap-4">
        <ShopAccount />
        <div className=" h-[100%] hidden sm:grid sm:col-span-5 xl:col-span-3 grid grid-rows-3 gap-5">
          <div className=" row-span-2 grid grid-cols-11 gap-4">
            <ShopInfo />
